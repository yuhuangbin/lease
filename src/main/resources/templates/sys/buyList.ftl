	...
	<div class="page-content">
		<div class="panel panel-bordered">
			<div class="panel-heading">
				<h3 class="panel-title">采购信息列表</h3>
			</div>
			<div class="panel-body">
				<div class="table-responsive">
					...
					<table class="table table-hover table-bordered">
						<thead>
						<tr>
							<th class="text-nowrap">产品编码</th>
                            <th class="text-nowrap">产品名称</th>
							<th class="text-nowrap">购入时间</th>
							<th class="text-nowrap">制作商</th>
							<th class="text-nowrap">购买价格</th>
							<th class="text-nowrap">长/宽/高</th>
							<th class="text-nowrap">功率</th>
							<th class="text-nowrap">租赁状态</th>
...
<div class="modal fade modal-fade-in-scale-up" id="noticeWin" aria-hidden="true" data-backdrop="static">
	<div class="modal-dialog modal-center">
		<form class="modal-content " id="noticeForm">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal"><span>×</span></button>
				<h4 class="modal-title">采购信息录入</h4>
			</div>
...
<script type="text/javascript" src="../../js/sys/buyList.js"></script>
